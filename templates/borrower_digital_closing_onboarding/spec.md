# Template spec: signer_digital_closing_onboarding

| | |
|---|---|
| **Template ID** | `signer_digital_closing_onboarding` |
| **Type** | `onboarding` |
| **Recipient** | signer |
| **Subject pattern** | Welcome to your digital closing with {{lender_name}} |
| **HAML generator** | `generateSignerOnboardingHaml()` in `frontend/src/App.jsx` |
...
This is the static reference copy. The authoritative generated version comes from `generateSignerOnboardingHaml()` in `frontend/src/App.jsx` via the Export tab.

```haml
-# Email template — auto-generated by Snapdocs Email Rewriter
-# Template:  signer_digital_closing_onboarding
-# Type:      onboarding
-# Recipient: signer
...
| `reply_guidance` | No reply path in signer onboarding |
